...
void CPicture::SetMachineAdapter(std::shared_ptr<CMachineAdapter> adapter)
{
	mMachineAdapter = adapter;

}

void CPicture::SetMachineAdapter2(std::shared_ptr<CMachineAdapter> adapter2)
{
	mMachineAdapter2 = adapter2;
}
