...
namespace Testing
{
	...
	{
	public:
		/** Virtual visit road function
		* \param road
		* incrementS through the tiles on the road
		*/
		virtual void VisitRoad(CTileRoad *road) override { mNumRoads++; }
		///sum of total road tiles
		int mNumRoads = 0;

		/** Virtual visit building function
		* \param road
		* incrementS through the tiles on the road
		*/
		virtual void VisitBuilding(CTileBuilding *building) override { mNumRoads++; }
		///sum of total building tiles
		int mNumBuilding = 0;

		/** Virtual visit coalmine function
		* \param road
		* incrementS through the tiles in the coalmine
		*/
		virtual void VisitCoalmine(CTileCoalmine *coalmine) override { mNumRoads++; }
		///sum of total coalmine tiles
		int mNumCoalmine = 0;
		
		/** Virtual visit Landscape function
		* \param road
		* incrementS through the tiles on the landscape
		*/
		virtual void VisitLandscape(CTileLandscape *coalmine) override { mNumRoads++; }
		///sum of total landscape tiles
		int mNumLandscape = 0;
	...
	public:
		...
		TEST_METHOD(TestCCityVisitor)
		{
			...
			Assert::AreEqual(1, visitor.mNumBuilding,
