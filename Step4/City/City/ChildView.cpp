...
/**
 * This function sets the coal mines
 */
...
/**
 * This function counts the number of buildings in a city
 */
...
/**
 * This function displays the Michigan Fan
 */
void CChildView::OnBigtenMichiganfan()
{
	auto tile = make_shared<CTileFans>(&mCity);
	tile->SetLocation(InitialX, InitialY);
	mCity.Add(tile);
	Invalidate();
}
...
/**
 * This function allows for OnBigtenPlay functionality
 */
void CChildView::OnBigtenPlay()
{

	// TODO: Add your command handler code here
	CFansVisitor visitFans;
	mCity.Accept(&visitFans);
	mUp = false;
	mDown = true;
...
/**
 * This function allows for a new Season instantiation
 */
void CChildView::OnBigtenNewseason()
{	
	CFansVisitor showPlay;
	mCity.Accept(&showPlay);
}
